...
namespace VeterinaryPrescriptionSystem.Web.Controllers
{
    ...
    public class PrescriptionsController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            try
            {
                _logger.LogInformation("Reçeteler sayfası yükleniyor...");
                ...
                _logger.LogInformation($"Toplam {prescriptions.Count} reçete bulundu.");
                return View(prescriptions);
            }
            catch (Exception ex)
            {
                _logger.LogError($"Reçeteler listelenirken bir hata oluştu: {ex}");
                TempData["Error"] = "Reçeteler listelenirken bir hata oluştu. Lütfen daha sonra tekrar deneyin.";
